...
//        }
     ...
     *  <li>Load all {@code classpath:dspace/config-*.cfg} using whatever matched "*" as module prefix.</li>
     *  <li>Load all {@code ${dspace.dir}/config/modules/*.cfg} using whatever matched "*" as module prefix.</li>
